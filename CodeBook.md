...
Every measurment for each item is aggreagted by Activity and Subject for mean and Standard deviation 
...
Activity - except this, this is for data category
Subject  - except this, this is for data category, actual data from below.
tBodyAcc-mean-X
tBodyAcc-mean-Y
tBodyAcc-mean-Z
tBodyAcc-std-X
